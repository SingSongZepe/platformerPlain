...
public class ScoreController {
    ...
    public void initialize() {
        ...
        int currentScore = ScoreCalculator.calculateScore(Main.gameState);
        ...
        int map_index = Main.gameState.map.index;
        ...
        if (currentScore > highScore) {
            loadedScores.set(
                    ...
                    new Score(
                            currentScore,
                            Main.gameState.map.index,
                            Main.gameState.map.map_name,
                            date
                    )
            );
        }
