...
public class MapsController {
    ...
    @FXML
    // Add image click effect when mouse click
    ...
    // Added image effect when mouse exit button (restore initial state)
    @FXML
