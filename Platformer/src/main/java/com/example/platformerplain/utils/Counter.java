...
import static com.example.platformerplain.Main.onCountdownEnd;
import static com.example.platformerplain.Main.timerLabelTimer;
...
public class Counter {
    public static void startCountdown(Label timerLabel) {
        ...
        timerLabelTimer.start(); // Main the countdown timer
    }
}
