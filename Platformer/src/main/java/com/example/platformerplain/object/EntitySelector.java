    ...
    private static void InsertEntityRuleLevel2(char c, int j, int i) {
        switch (c) {
            ...
            case '2': // obstacle: stone
                ...
                platforms.add(stone_block_image);
                gameRoot.getChildren().add(stone_block_image);
                break;
            ...
            case '3': // obstacle: cactus
                ...
                platforms.add(cactus_image);
                gameRoot.getChildren().add(cactus_image);
                break;
            ...
            case '4': // enemy: fire dragon
                ...
                enemyNodes.add(fire_dragon);
                movableNodes.add(fire_dragon);
                gameRoot.getChildren().add(fire_dragon_image);
                break;
            ...
            case '5': // enemy: mummy
                ...
                enemyNodes.add(mummy);
                movableNodes.add(mummy);
                gameRoot.getChildren().add(mummy_image);
                break;
...
//                        platforms.add(cookie_image);
            ...
            case '9': // flying carpet
                ...
                platforms.add(flying_carpet_image);
                movableNodes.add(new FlyingCarpetNode(MovableObjectNode.FLYING_CARPET_, flying_carpet_image, flying_carpet_block.getRange()));
                gameRoot.getChildren().add(flying_carpet_image);
                break;
            ...
            case 'a': // destination: oasis
                ...
                destinationNode = new DestinationNode(DestinationBlock.OASIS_, oasis_image);
                gameRoot.getChildren().add(oasis_image);
                break;
